...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO patient_entry (patient_name, therapist, age, disabilities, special_note) VALUES ('$Patient_name' , '$Therapist' , '$Age' , '$Disabilities', '$Special_note')";


    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-container">';
        echo '<div class="success-box">';
        echo '<h1>Paitent record added successfully.</h1>';
