...
$sql = "SELECT Msg_id, patient_name, patient_type , therapist_name, subject, message, sent_at FROM therapist_message WHERE patient_type = 'patient_specialneeds' ORDER BY sent_at DESC";
