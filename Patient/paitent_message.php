...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $paitent_name = $_POST['patient_name'];
    $subject = $_POST['subject'];
    $message = $_POST['message'];

    $sql = "INSERT INTO paitentmessage (therapist_name , patient_name, subject, message) VALUES ('$therapist_name' , '$paitent_name' ,   '$subject', '$message')";
...
<script>
        function goHome() {
            window.location.href = "../Patient/paitent_message.html"; // Replace with your actual home page URL
        }
    </script>
</body>
</html>