...
$name = $role = $email = $phone_number = $age = $filename = "";
...
if (isset($_POST["submit"])) {
    ...
    if (move_uploaded_file($tempname, $folder)) {
        ...
        $sql = "INSERT INTO paitents_personal_info (filename, name, role, email, phone_number, age) 
                VALUES ('$filename', '$name', '$role', '$email', '$phone_number', '$age')";
...
<br>
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data">
            <center>
            <div>
            <img id="preview" src="../Resourses/index/persInfo.png" alt="Profile Image Preview" />
        </div>
            </center>
