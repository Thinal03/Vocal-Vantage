...
@media (max-width: 480px) {
    ...
    /*who-we-are*/
    .who-we-are-intro {
        background: linear-gradient(135deg, #02835633, #E9EDF4);
    }
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <a href="">Home</a>
                <a href="patient note entry .html">Patient Entry Form</a>
                <a href="#WHAT WE TREAT">What We Treat</a>
                <a href="#Doctor-Detail-Profile">Therapists</a>
                <a href="Appoinments_calender.php">Appointments</a>
                ...
                <select id="report" name="report_type" required onchange="window.location.href=this.value;">
                    ...
                    <option value="patient report.php">Patient Report</option>
                    <option value="platform report_adult.php">Platform Report</option>
                </select>
    ...
    overlay.addEventListener("click", () => {
        ...
        <section class="who-we-are-intro">
            <div class="who-we-are">
                <img src="../Resourses/Adult/project-image-new.png" alt="Who we are">

                <div class="who-we-are-text">
                    <h2>ONLINE SPEECH THERAPY</h2><br>
                    <h1>Adult Speech Therapy</h1>
...
$appointments = [];
$sql = "SELECT date FROM appoinments WHERE role = 'patient_adult'";
            ...
            <div id="appointmentPopup">
                <div class="form-container">
                    ...
                    <form action="Appoinments.php" method="POST">
                        ...
                        <option value="patient_adult">Patient - Adult </option>
                        </select>
...
<script>const services = {
    "speech-delay": {
        ...
        image: "../Resourses/Adult/delayadult01.jpg"
    },
    "voice-disorder": {
        ...
        image: "../Resourses/Adult/voiceadult01.jpg"
    },
    "aphasia": {
        title: "Aphasia",
        ...
        image: "../Resourses/Adult/aphasiaadult.jpg"
    },
    "autism": {
        ...
        image: "../Resourses/Adult/autisamadult.jpg"
    },
    "lisp": {
        title: "Lisp",
        ...
        image: "../Resourses/Adult/lisp.jpg"
    },
    "stuttering": {
        title: "Stuttering",
        ...
        image: "../Resourses/Adult/stuttering-adult.jpg"
    },
    "apraxia": {
        ...
        image: "../Resourses/Adult/apraxiaadult.jpg"
    },
    "sound": {
        ...
        image: "../Resourses/Adult/speech-adult.jpeg"
    },
    "accent": {
        ...
        image: "../Resourses/Adult/accent-adult.jpg"
    }
};
