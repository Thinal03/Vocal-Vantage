...
<head>
    ...
    <title>Patient-Specisl needs Home Page</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="Appoinments_calender_specialneed.php">Appointments</a>
                <a href="zoom_specialneeds.php">Attend Live Session</a>
                ...
                <select id="report" name="report_type" required onchange="window.location.href=this.value;">
                    ...
                    <option value="patient report_specialneeds.php">Patient Report</option>
    ...
    <div class="message-item">
        ...
        <a href="inbox_specialneeds.php">Inbox</a>
    </div>
    <div class="message-item">
...
$appointments = [];
$sql = "SELECT date FROM appoinments WHERE role = 'patient_specialneeds'";
            ...
            <div id="appointmentPopup">
                <div class="form-container">
                    ...
                    <form action="Appoinments.php" method="POST">
                        ...
                        <option value="patient_specialneeds">Patient - Special Needs </option>
                        </select>
