...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO therapist_message (patient_name, patient_type , therapist_name , subject, message) VALUES ('$patient_name' , '$patient_type' , '$therapist_name' ,  '$subject', '$message')";
    
    if ($conn->query($sql) === TRUE) {
        echo '<div class="success-container">';
        echo '<div class="success-box">';
        echo '<h1>Message Sent Successfully!</h1>';
        echo '<p>Thank you for reaching out. Your message has been sent to your patient.</p>';
