...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO guardian_personal_info (filename, name, gname, email, phone_number, age) 
            VALUES ('$filename', '$name', '$gname', '$email', '$phone_number', '$age')";
...
<body>
    ...
    <img src="../Resourses/index/logo 01.png">
        ...
        <div class="auth-buttons">
            <a href="guardian Home page.php"><button class="signup" >Back to Home</button></a>
        </div>
    </header>
<br>
...
<script>
        function goHome() {
            window.location.href = "guardian Home page.php"; // Replace actual home page URL
        }
    </script>
