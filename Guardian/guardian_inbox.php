...
// Fetch messages where patient_type is 'patient_specialneeds' or 'patient_child'
$sql = "SELECT Msg_id, patient_name, patient_type, therapist_name, subject, message, sent_at 
        FROM therapist_message 
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td data-label='Action'>
                                <button type='submit'><a href='gudian_sent_msg.php'>Reply</a></button>
                                </form>
                            </td>
                          </tr>";
                }
