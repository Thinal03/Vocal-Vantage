...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO platform_reports_therapist (report_id, role, name, subject, description, special_note) 
            VALUES ('$report_id', '$role', '$name', '$subject', '$description', '$special_note')";

if ($conn->query($sql) === TRUE) {
    echo "<script>
            alert('Report sent successful');
            window.location.href = 'platformreport_therapist.php';
          </script>";
} else {
...
<head>
    ...
    <title>Admin - Therapist - Platform Report </title>
    <style>
       /* General Reset */
       * {
    margin: 0;
