...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO platform_reports_child (report_id, role, name, subject, description, special_note) 
            VALUES ('$report_id', '$role', '$name', '$subject', '$description', '$special_note')";

if ($conn->query($sql) === TRUE) {
    echo "<script>
            alert('Report sent successful');
            window.location.href = 'platformreport_paitentchild.php';
          </script>";
} else {
...
<head>
    ...
    <title>Platform Report Form - Paitent - Child</title>
    <style>
         /* General Reset */
         * {
    margin: 0;
...
<body>
    ...
    <div class="container">
        <h1>Patient - child Platform Report Form</h1>
