...
if (isset($_GET['delete'])) {
    ...
    $deleteQuery = "DELETE FROM paitents_personal_info WHERE id=$id";

    if (mysqli_query($connect, $deleteQuery)) {
        echo "<script>alert('Record deleted successfully');</script>";
        echo "<script>window.location.href='paitent_personal_info.php';</script>";
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_id'])) {
    ...
    $updateQuery = "UPDATE paitents_personal_info 
                    SET name='$name', role='$role', email='$email', phone_number='$phone', age=$age 
                    WHERE id=$id";
...
$sql = "SELECT * FROM paitents_personal_info";
...
<body>
    ...
    <div class="dashboard-container"><br>
        <h2>Admin Dashboard - Patient Personal Info</h2><br>
            ...
            <table>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            <td><img src="../Patient/files/<?php echo htmlspecialchars($row['filename']); ?>" alt="Profile"></td>
    ...
    <div class="modal" id="editModal">
        <div class="modal-content">
            ...
            <h2>Updated- Patient Personal Info</h2><br>
