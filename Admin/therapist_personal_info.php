...
if (isset($_GET['delete'])) {
    ...
    $deleteQuery = "DELETE FROM personal_info WHERE id=$id";

    if (mysqli_query($connect, $deleteQuery)) {
        echo "<script>alert('Record deleted successfully');</script>";
        echo "<script>window.location.href='therapist_personal_info.php';</script>";
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_id'])) {
    $id = intval($_POST['edit_id']); // Sanitize input
    $name = mysqli_real_escape_string($connect, $_POST['name']);
    $speaciality = mysqli_real_escape_string($connect, $_POST['speaciality']);
    $email = mysqli_real_escape_string($connect, $_POST['email']);
    $phone = mysqli_real_escape_string($connect, $_POST['phone']);
    $age = intval($_POST['age']);

    $updateQuery = "UPDATE personal_info 
                    SET name='$name', speaciality='$speaciality', email='$email', phone_number='$phone', age=$age 
                    WHERE id=$id";
...
<head>
    ...
    <title>Admin Dashboard - Therapist Personal Info</title>
    <style>
       /* General Reset */
       * {
    margin: 0;
...
<body>
    ...
    <div class="dashboard-container"><br>
        <h2>Admin Dashboard - Therapist Personal Info</h2><br>
            ...
            <table>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            <td><img src="../therapist/files/<?php echo htmlspecialchars($row['filename']); ?>" alt="Profile"></td>
    ...
    <div class="modal" id="editModal">
        <div class="modal-content">
            ...
            <h2>Update - Therapist Personal Info</h2><br>
            <form method="POST" action="">
                <input type="hidden" id="edit_id" name="edit_id">
                <label for="name">Name:</label>
                <input type="text" id="edit_name" name="name" required>
                <label for="speaciality">Speaciality:</label>
                <input type="text" id="edit_speaciality" name="speaciality" required>
    ...
    document.getElementById('edit_speaciality').value = data.speaciality;
