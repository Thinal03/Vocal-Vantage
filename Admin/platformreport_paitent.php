...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO platform_reports (report_id, role, name, subject, description, special_note) 
            VALUES ('$report_id', '$role', '$name', '$subject', '$description', '$special_note')";

if ($conn->query($sql) === TRUE) {
    echo "<script>
            alert('Report sent successful');
            window.location.href = 'platformreport.php';
          </script>";
} else {
...
<head>
    ...
    <title>Platform Report Form - Paitent - Adult</title>
    <style>
       /* General Reset */
       * {
    margin: 0;
...
<body>
    ...
    <div class="container">
        <h1>Patient - Adult Report Form</h1>
